...
async def fetch_player_data_by_pid(player_pid: str, uid: Optional[str] = None, token: Optional[str] = None, hostnum: int = 10595, fields: Optional[List[str]] = None) -> Optional[Dict[str, Any]]:
    """
